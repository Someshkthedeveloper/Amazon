    ...
    <>
      <div className="footer-main">
        <div className="backtotop">
          <a href="#">
            <h2 className="h3tag">Back To Top</h2>
          </a>
        </div>
        ...
        <div className="line">
          <div className="footerpage">
            ...
            <div>
              ...
              <h3>
                <a href="https://www.amazonpay.in/merchant" class="nav_a">
            ...
            <div>
              ...
              <h3>
                <a href="/gp/css/homepage.html?ref_=footer_ya" class="nav_a">
                  Your Account
                </a>
              </h3>
              <h3>
          ...
          <div className="main_footer">
            ...
            <div className="img_foot">
              <img src={amazon} alt="" className="amazon_img" style={{width:"100px", height:"30px"}} />
            </div>
            <div className="footer_button_op">
                <button>
              <section>
                
                <select value="" className="select-foot">
                  {footer.map((x)=><option>{x.language}</option>)}
                  {/* {footer.map((val) => <div className="op">{ val.language} </div>)} */}
                </select>
            ...
            <div className="national">
              <button>
                <div className="total_but">
                  <div>
                    <img src={flag} alt="" className="but_img" style={{width:"20px", height:"15px"}} />
                  </div>
          ...
          <div className="developed">Developed By Agash | Somesh | Vinith | Vinoth </div>
        </div>
      </div>
    </>
  );
